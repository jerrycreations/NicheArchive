...
describe("proxy", () => {
  it("sends a locked page request to the unlock page, remembering where it was going", async () => {
  ...
  it("answers a locked API request with 401 JSON", async () => {
  ...
  it("lets an unlocked device through", async () => {
